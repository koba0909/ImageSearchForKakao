 ...
 */
public abstract class Hilt_SearchFragment<B extends ViewDataBinding> extends BaseDataBindingFragment<B> implements GeneratedComponentManagerHolder {
  ...
  Hilt_SearchFragment(int layoutResId) {
    super(layoutResId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SearchFragment_GeneratedInjector) this.generatedComponent()).injectSearchFragment(UnsafeCasts.<SearchFragment>unsafeCast(this));
    }
  }
